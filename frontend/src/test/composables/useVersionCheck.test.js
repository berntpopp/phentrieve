...
describe('useVersionCheck', () => {
  ...
  it('refreshVersions populates version refs on success', async () => {
    ...
    const { frontendVersion, apiVersion, cliVersion, environment, loadingVersions, refreshVersions } =
      useVersionCheck()
  ...
  it('sets loadingVersions to true during fetch', async () => {
    let resolvePromise
    getAllVersions.mockReturnValue(new Promise((resolve) => { resolvePromise = resolve }))
