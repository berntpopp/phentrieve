...
from multilingual_hpo_rag.retrieval import reranker
from multilingual_hpo_rag.utils import (
    ...
    if sentence_mode:
        ...
        if (
            ...
            for result in original_results:
                ...
                # Convert HPO ID format from HP:NNNNNNN to HP_NNNNNNN to match ChromaDB storage format
                chroma_compatible_id = hpo_id.replace(":", "_")
                if debug:
                    print(f"[DEBUG] Looking for ChromaDB ID: {chroma_compatible_id}")
