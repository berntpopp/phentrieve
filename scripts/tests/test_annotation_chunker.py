...
def test_generate_chunk_variants_single_annotation():
    ...
    assert chunk["variants"]["0.00"]["span"] == [14, 27]
...
def test_generate_chunk_variants_expansion_calculation():
    """Test exact expansion calculation for 0.5 ratio."""
    ...
    # Check expansion
    expected_left = 5 - int(5 * 0.5)  # 5 - 2 = 3
    expected_right = 10 + int(4 * 0.5)  # 10 + 2 = 12
    assert variant["span"] == [expected_left, expected_right]
