...
fig, axes = plt.subplots(len(hr_metrics), 1, figsize=(12, 4*len(hr_metrics)), squeeze=False)
...
ont_metrics = ["OntSim@1 (Dense)", "OntSim@3 (Dense)", "OntSim@5 (Dense)", "OntSim@10 (Dense)"]
fig, axes = plt.subplots(len(ont_metrics), 1, figsize=(12, 4*len(ont_metrics)), squeeze=False)
