...
actual_package_dir = os.path.join(project_root, "phentrieve")
...
try:
    ...
    # Fall back to full package path
    from phentrieve.evaluation.result_analyzer import (
        load_summary_files,
        deduplicate_summaries,
        prepare_comparison_dataframe,
        prepare_flat_dataframe_for_plotting,
...
try:
    ...
    # Fall back to full package path
    from phentrieve.visualization.plot_utils import (
        plot_mrr_comparison,
        plot_metric_at_k_bars,
        plot_metric_at_k_lines,
        K_VALUES_DEFAULT,
