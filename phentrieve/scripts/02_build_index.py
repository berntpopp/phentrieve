...
from phentrieve.config import DEFAULT_MODEL, INDEX_DIR, BENCHMARK_MODELS
...
from phentrieve.utils import get_model_slug, generate_collection_name
        ...
        for model_name in BENCHMARK_MODELS:
            ...
            try:
                ...
                result = build_chromadb_index(
                    documents=documents,  # Pass the documents directly
                    metadatas=metadatas,
                    ids=ids,
                    model=current_model,
                    model_name=model_name,
